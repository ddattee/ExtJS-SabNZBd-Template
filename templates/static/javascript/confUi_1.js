var confPan = new Ext.TabPanel({
    ...
    items: [
                    ...
                    sm: new Ext.grid.RowSelectionModel({
                        ...
                        listeners: {
                            rowselect: function(sm, row, rec) {
                                ...
                                var form = Ext.getCmp("servEdit").getForm();
                                form.loadRecord(rec);
                                Ext.getCmp('serverName').disable();
                                Ext.getCmp('saveServButton').hide();
                                Ext.getCmp("servEdit").expand();
                                $.each(form.items.items,function(key, item){
        ...
        },
        {
            ...
            listeners: {
                activate : function(){
                    Ext.getCmp('rss').setIconClass('loading-tab');
                    loadConfFeeds();
                }
            },
            items:[
        ...
        },
        {
            ...
            listeners: {
                activate : function(){
                    Ext.getCmp('mail').setIconClass('loading-tab');
                    loadConfMail();
                }
            },
            items:[ formMail]
